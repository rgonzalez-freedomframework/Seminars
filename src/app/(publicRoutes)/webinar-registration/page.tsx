...
export default function WebinarRegistration() {
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b border-[#CCA43B]/20 transition-all duration-300" >
        <div className="container mx-auto px-4 py-3 md:py-4 transition-all duration-300">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <Link href="/">
                <Button size="lg" variant="outline" className="!border-2 !border-[#1D2A38]/40 !text-[#1D2A38] !bg-white/80 hover:!bg-[#CCA43B]/20 font-semibold px-4 py-2 transition-all" >
                  <Home className="h-4 w-4 mr-2" /> Home
                </Button>
              </Link>
              <Link href="/sign-in">
                <Button size="lg" variant="outline" className="!border-2 !border-[#1D2A38]/40 !text-[#1D2A38] !bg-white/80 hover:!bg-[#CCA43B]/20 font-semibold px-4 py-2 md:px-6 md:py-3 transition-all" >
                  Login
                </Button>
              </Link>
            </div>
      ...
      <main className="pt-28 pb-20 relative z-10">
        <div className="container mx-auto px-4 max-w-6xl space-y-16">
          ...
          {/* Hero Section */}
          <section className="relative overflow-hidden rounded-3xl border border-[#CCA43B]/30 bg-white/80 backdrop-blur-md px-6 py-10 md:px-10 md:py-14 shadow-lg animate-in fade-in slide-in-from-bottom duration-700">
          ...
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/80 backdrop-blur-md p-6 md:p-8 shadow-md animate-in fade-in slide-in-from-bottom duration-700">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-6 md:gap-8 md:grid-cols-2">
              <article className="rounded-3xl border border-[#1D2A38]/25 bg-white/80 backdrop-blur-md p-6 md:p-7 shadow-md hover:shadow-lg transition-all" >
          ...
          <section className="grid gap-8 md:grid-cols-2 items-start">
            <div className="rounded-3xl border border-[#1D2A38]/25 bg-white/80 backdrop-blur-md p-6 md:p-8 shadow-md">
            ...
            <div className="rounded-3xl border border-[#CCA43B]/40 bg-gradient-to-br from-[#CCA43B]/15 to-white/10 backdrop-blur-md p-6 md:p-8 shadow-md">
          ...
          {/* Event Details */}
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/80 backdrop-blur-md p-6 md:p-8 text-center shadow-md">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              <div className="rounded-2xl border border-[#1D2A38]/25 bg-white/80 p-5 shadow-sm hover:shadow-md transition-all">
          ...
          {/* Final CTA */}
          <section className="rounded-3xl border border-[#CCA43B]/50 bg-gradient-to-r from-[#CCA43B]/25 via-white/20 to-[#1D2A38]/15 backdrop-blur-md px-6 py-10 md:px-10 md:py-12 text-center shadow-lg">
      ...
      {/* Footer */}
      <footer className="py-8 md:py-12 border-t border-[#1D2A38]/25 bg-white/50 backdrop-blur-sm relative z-10 shadow-sm">
