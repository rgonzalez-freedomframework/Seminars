      ...
      <main className="pt-28 pb-20 relative z-10">
        <div className="container mx-auto px-4 max-w-6xl space-y-16">
          ...
          <section className="relative overflow-hidden rounded-3xl border border-[#CCA43B]/20 bg-white/5 backdrop-blur-md shadow-xl px-6 py-10 md:px-10 md:py-14 animate-in fade-in slide-in-from-bottom duration-700">
            ...
            <div className="relative text-center space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 inline-block">
                <p className="text-sm md:text-base text-white/90 mb-3 flex items-start gap-2">
          ...
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-md animate-in fade-in slide-in-from-bottom duration-700">
            ...
            <div className="bg-gradient-to-br from-[#CCA43B]/10 to-white/5 rounded-2xl border border-[#CCA43B]/40 p-6 md:p-8">
              <div className="flex items-start gap-3 mb-4">
                <Gift className="h-6 w-6 text-[#CCA43B] flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Your Freedom Matrix Diagnostic™ (Email Delivery Required)</h3>
                  <p className="text-white/90 mb-3">A 5-minute assessment that identifies your firm's exact quadrant:</p>
                </div>
              </div>

              <ul className="space-y-2 text-white/90 mb-4 ml-9">
              ...
              <p className="text-white/90 font-semibold mb-3 ml-9">Your result includes:</p>
              <ul className="space-y-2 text-white/90 ml-9">
              ...
              <p className="text-white/80 italic mt-4 ml-9">Your score will arrive by email once you register.</p>
            </div>
          </section>

          {/* What You'll Learn */}
          <section className="space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-white text-center">⭐ What You'll Learn During the Free 2-Hour Masterclass</h2>
            ...
            <div className="grid gap-6 md:gap-8 md:grid-cols-2">
              <article className="rounded-3xl border border-gray-200/20 bg-white/5 backdrop-blur-md p-6 md:p-7 shadow-sm hover:shadow-md transition-all">
                ...
                <p className="text-white/90 mb-2">You'll understand the difference between:</p>
          ...
          <section className="grid gap-8 md:grid-cols-2 items-start">
            <div className="rounded-3xl border border-gray-200/20 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-md">
              ...
              <p className="text-white/90 mt-5 font-semibold">
          ...
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/5 backdrop-blur-md p-6 md:p-8 shadow-md text-center">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 max-w-4xl mx-auto">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-white/90 font-semibold">[Insert date]</p>
              </div>

              <div className="flex flex-col items-center gap-2">
                <Clock className="h-8 w-8 text-[#CCA43B]" />
                <p className="text-sm text-white/70">Time</p>
                <p className="text-white/90 font-semibold">[Insert time]</p>
              </div>

              <div className="flex flex-col items-center gap-2">
                <Clock className="h-8 w-8 text-[#CCA43B]" />
                <p className="text-sm text-white/70">Length</p>
                <p className="text-white/90 font-semibold">2 hours</p>
              </div>

              <div className="flex flex-col items-center gap-2">
                <Video className="h-8 w-8 text-[#CCA43B]" />
                <p className="text-sm text-white/70">Format</p>
                <p className="text-white/90 font-semibold">Live on Zoom</p>
              </div>
            </div>
