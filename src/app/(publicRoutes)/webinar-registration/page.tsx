...
export default function WebinarRegistration() {
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm border-b border-[#CCA43B]/20 transition-all duration-300" style={{ boxShadow: 'none' }}>
      ...
      <main className="pt-28 pb-20 relative z-10">
        <div className="container mx-auto px-4 max-w-6xl space-y-16">
          ...
          <section className="relative overflow-hidden rounded-3xl border border-[#CCA43B]/30 bg-white/60 backdrop-blur-md px-6 py-10 md:px-10 md:py-14 animate-in fade-in slide-in-from-bottom duration-700" style={{ boxShadow: 'none' }}>
            ...
            <div className="relative text-center space-y-6">
              ...
              <div className="flex justify-center">
                <Link href="/sign-in">
                  <Button className="bg-gradient-to-r from-[#CCA43B] to-[#B8932F] hover:from-[#B8932F] hover:to-[#CCA43B] text-white font-bold px-8 py-4 text-lg rounded-xl border-2 border-[#CCA43B] transition-all flex items-center gap-2" style={{ boxShadow: 'none' }}>
                    Register Now — Free
          ...
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/60 backdrop-blur-md p-6 md:p-8 animate-in fade-in slide-in-from-bottom duration-700" style={{ boxShadow: 'none' }}>
            ...
            <div className="bg-gradient-to-br from-[#CCA43B]/15 to-white/10 rounded-2xl border border-[#CCA43B]/40 p-6 md:p-8">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-6 md:gap-8 md:grid-cols-2">
              <article className="rounded-3xl border border-[#1D2A38]/20 bg-white/60 backdrop-blur-md p-6 md:p-7 transition-all" style={{ boxShadow: 'none' }}>
          ...
          {/* What You Receive */}
          <section className="rounded-3xl border border-[#CCA43B]/40 bg-[#1D2A38] backdrop-blur-md text-white px-6 py-8 md:px-10 md:py-10" style={{ boxShadow: 'none' }}>
          ...
          <section className="grid gap-8 md:grid-cols-2 items-start">
            <div className="rounded-3xl border border-[#1D2A38]/20 bg-white/60 backdrop-blur-md p-6 md:p-8" style={{ boxShadow: 'none' }}>
            ...
            <div className="rounded-3xl border border-[#CCA43B]/40 bg-gradient-to-br from-[#CCA43B]/15 to-white/10 backdrop-blur-md p-6 md:p-8" style={{ boxShadow: 'none' }}>
          ...
          {/* Event Details */}
          <section className="rounded-3xl border border-[#CCA43B]/30 bg-white/60 backdrop-blur-md p-6 md:p-8 text-center" style={{ boxShadow: 'none' }}>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              <div className="rounded-2xl border border-[#1D2A38]/20 bg-white/60 p-5" style={{ boxShadow: 'none' }}>
          ...
          {/* Final CTA */}
          <section className="rounded-3xl border border-[#CCA43B]/50 bg-gradient-to-r from-[#CCA43B]/25 via-white/20 to-[#1D2A38]/15 backdrop-blur-md px-6 py-10 md:px-10 md:py-12 text-center" style={{ boxShadow: 'none' }}>
            ...
            <Link href="/sign-in">
              <Button className="bg-gradient-to-r from-[#CCA43B] to-[#B8932F] hover:from-[#B8932F] hover:to-[#CCA43B] text-white font-bold px-10 py-4 text-lg rounded-xl border-2 border-[#CCA43B] transition-all inline-flex items-center gap-2" style={{ boxShadow: 'none' }}>
                Register Now — Free
                <ArrowRight className="h-5 w-5" />
              </Button>
            </Link>
      ...
      {/* Footer */}
      <footer className="py-8 md:py-12 border-t border-[#1D2A38]/20 bg-white/40 backdrop-blur-sm relative z-10">
