  ...
  <div className="w-full h-full mt-8 px-6 md:px-8 lg:px-10 xl:px-12">
    <div className="w-full flex justify-center sm:justify-between items-center gap-8 flex-wrap">
        ...
        <div className="relative md:mr-28">
            <PurpleIcon className="absolute -left-4 -top-3 -z-10 -rotate-45 py-3 [&_svg]:!text-[#1D2A38] [&_svg]:!stroke-[#1D2A38]">
            {leftIcon}
            </PurpleIcon>
            <PurpleIcon className="z-10 [&_svg]:!text-[#1D2A38] [&_svg]:!stroke-[#1D2A38]">{mainIcon}</PurpleIcon>
            <PurpleIcon className="absolute -right-4 -top-3 -z-10 py-3 rotate-45 [&_svg]:!text-[#1D2A38] [&_svg]:!stroke-[#1D2A38]">
            {rightIcon}
            </PurpleIcon>
        </div>
    </div>
